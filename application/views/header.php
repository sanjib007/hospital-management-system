    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header white-bg">
                ...
                <!--logo start-->
                <a href="#" class="logo">Hospital<span>Management System</span></a>
                <!--logo end-->
                ...
                <div class="top-nav ">
                    ...
                    <ul class="nav pull-right top-menu" id="nav">
                        <li>
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <?php
                                if ($this->session->userdata('avater')) {
                                    echo img('img/' . $this->session->userdata('avater'));
                                } else {
                                    echo img('img/no_preview.jpg');
                                }
                                ?>
                ...
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li class="<?php echo active_link('adminprofile'); ?>"><a href="<?php echo site_url('adminprofile'); ?>">Create User</a></li> 
                                <li class="<?php echo active_link('userinfo'); ?>"><a href="<?php echo site_url('userinfo'); ?>">Show User</a></li> 
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;" class="">
                            ...
                            <ul class="sub">
                                <li><a class="" href="<?php echo site_url('patient/'); ?>">New Patient</a></li>
                                <li><a class="" href="<?php echo site_url('userinfo/'); ?>">Show User</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="" href="<?php echo base_url(); ?>client/">Create New Client</a></li>
                                <li><a class="" href="<?php echo base_url(); ?>client/search_client">Search Client</a></li>
                                <li><a class="" href="<?php echo base_url(); ?>client/appointment_view">Appointment</a></li>
